...
def test_sufix():
    ...
    #Call prefix function and verify that its returns a stringS
    sup =suffix("Angelic", "Awesome")
    assert isinstance(sup,str)

    #call the prefix function nine time and use an assert function to verified that the string 
    # retourned by prefix function correct.
